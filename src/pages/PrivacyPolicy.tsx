...
import { privacySections } from "@/data/bejoContent";
                ...
                <div className="container mx-auto max-w-5xl px-4">
                    ...
                    <AnimatedSection direction="scale">
                        <div className="mb-10 rounded-[2rem] border border-white/10 bg-[#0c1020]/85 p-8 text-center shadow-2xl shadow-black/30 backdrop-blur-xl md:p-12">
                            ...
                            <h1 className="font-heading text-4xl font-bold text-white md:text-5xl">Privacy Policy</h1>
                            <p className="mx-auto mt-5 max-w-3xl text-base leading-relaxed text-slate-300/85">
                                This Privacy Policy explains how Bejo collects, uses, shares, stores, and protects personal information. It is designed to support GDPR, CCPA/CPRA, and India DPDP Act requirements.
                            </p>
                        ...
                        <article className="rounded-[1.75rem] border border-white/10 bg-[#0c1020]/85 p-6 shadow-2xl shadow-black/20 backdrop-blur-xl md:p-10">
                            <div className="space-y-10">
                                ...
                                <section className="rounded-2xl border border-[#8d7cff]/20 bg-[#8d7cff]/10 p-6">
                                    ...
                                    <p className="text-sm leading-relaxed text-slate-300/85 md:text-base">
                                        For privacy rights, grievance requests, support, or abuse concerns, contact{" "}
                                        <a href="mailto:privacy.bejo@one8onestudios.com" className="text-[#bdb4ff] hover:underline">
                                            privacy.bejo@one8onestudios.com
                                        </a>{" "}
                                        or{" "}
                                        <a href="mailto:support.bejo@one8onestudios.com" className="text-[#bdb4ff] hover:underline">
                                            support.bejo@one8onestudios.com
                                        </a>
                                        .
                                    </p>
                                </section>
